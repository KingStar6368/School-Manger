...
namespace School_Manager.Data.Migrations
{
    ...
    [Migration("20251018213345_Change Bills Bills Beheviore Resited_Cascade")]
    partial class ChangeBillsBillsBehevioreResited_Cascade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.DriverChild", b =>
                {
                    ...
                    b.Property<long?>("DriverShiftRef")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.DriverShift", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.SMSLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.SMSTemple", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.Setting", b =>
                {
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.Shift", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.Tariff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.Child", b =>
                {
                    ...
                    b.HasOne("School_Manager.Domain.Entities.Catalog.Operation.Shift", "ShiftNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("School_Manager.Domain.Entities.Catalog.Operation.DriverChild", b =>
                {
                    ...
                    b.HasOne("School_Manager.Domain.Entities.Catalog.Operation.Driver", null)
                        .WithMany("Passanger")
                        .HasForeignKey("DriverId");

                    b.HasOne("School_Manager.Domain.Entities.Catalog.Operation.DriverShift", "DriverShiftNavigation")
                        .WithMany("Passenger")
                        .HasForeignKey("DriverShiftRef")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ChildNavigation");

                    b.Navigation("DriverShiftNavigation");
                });
